### Marine fish catch - Trade Correction 
### and print the file
...
### Compute the % breakdown of marine/freshwater in FAOSTAT
### Could present the comparison of survey VS FAO(FW & MAR) as bargraph colored by source FW/MAR

# read all FAOSTAT catch
ca_all <- read.csv('../data/catch_yield/FishStatJ/exported_from_fishstatj/global_catch_production_all.csv')

# clean data, compute total marine and freshw., calculate %
