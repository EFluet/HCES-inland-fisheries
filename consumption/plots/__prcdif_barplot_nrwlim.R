...
t80 <-  ggplot(ca_ctry_jnd_t80, 
  ...
  # coord_flip(ylim=c(lim[1], lim[2])) +
  # scale_y_continuous(breaks = seq(lim[1], lim[2], by = 100)) +
  scale_y_continuous(breaks = c( seq(lim[1], lim[2], by = 300))) +
...
ggsave("../output/figures/survey_fao_bargraph_sep80n20_nrwlim_align.png", p, 
