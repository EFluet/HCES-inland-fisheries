...
s1_top80 <- ggplot(consump_nat_agg_df_f80, aes(x = sum_catch_millions * 1000, #convert values to thousand tons 
                                y = consump_million.tons.yr_fwaes_noimp,
                                colour = continent)) +
  ...
  geom_text(x=1.15, y=2.41, label="2:1", angle=67.5, fontface='italic', size=4, colour='grey85') +
  geom_text(x=1.15, y=1.23, label="1:1", angle=45, fontface='italic', size=4, colour='grey85') +
  geom_text(x=1.15, y=0.63, label="1:2", angle=22.5, fontface='italic', size=4, colour='grey85') +
...
s2_bot20 <- ggplot(consump_nat_agg_df_b20, aes(x = sum_catch_millions*1000,  # convert values to thousand tons 
  ...
  geom_text(x=0.19, y=0.108, label="1:2", angle=22.5, fontface='italic', size=4, colour='grey85') +
  geom_text(x=0.19, y=0.202, label="1:1", angle=45, fontface='italic', size=4, colour='grey85') +
  geom_text(x=0.19, y=0.402, label="2:1", angle=67.5, fontface='italic', size=4, colour='grey85') +
